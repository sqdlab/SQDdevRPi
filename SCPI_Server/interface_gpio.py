...
class PiGPIO(SCPIBase):    
    ...
    def __init__(self):
        ...
        self._pins = [
            ...
            PiGPIO.Pin(3, GPIO.IN, True, GPIO.PUD_UP, pud_fix=True, description='I2C_SDA'),
            PiGPIO.Pin(4, GPIO.OUT, True, GPIO.PUD_UP, setup=False, mode_fix=True, val_fix=True, pud_fix=True, description='5V supply'),
            PiGPIO.Pin(5, GPIO.IN, True, GPIO.PUD_UP, pud_fix=True, description='I2C_SCL'),
            PiGPIO.Pin(6, GPIO.OUT, False, GPIO.PUD_DOWN, setup=False, mode_fix=True, val_fix=True, pud_fix=True, description='GND'),
            PiGPIO.Pin(7, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(8, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(9, GPIO.OUT, False, GPIO.PUD_DOWN, setup=False, mode_fix=True, val_fix=True, pud_fix=True, description='GND'),
            PiGPIO.Pin(10, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(11, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(12, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(13, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(14, GPIO.OUT, False, GPIO.PUD_DOWN, setup=False, mode_fix=True, val_fix=True, pud_fix=True, description='GND'),
            PiGPIO.Pin(15, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(16, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(17, GPIO.OUT, True, GPIO.PUD_UP, setup=False, mode_fix=True, val_fix=True, pud_fix=True, description='3V3 supply'),
            PiGPIO.Pin(18, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(19, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(20, GPIO.OUT, False, GPIO.PUD_DOWN, setup=False, mode_fix=True, val_fix=True, pud_fix=True, description='GND'),
            PiGPIO.Pin(21, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(22, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(23, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(24, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO'),
            PiGPIO.Pin(25, GPIO.OUT, False, GPIO.PUD_DOWN, setup=False, mode_fix=True, val_fix=True, pud_fix=True, description='GND'),
            PiGPIO.Pin(26, GPIO.IN, False, GPIO.PUD_OFF, description='GPIO')
        ]
